...
// FETCH FROM POLYMARKET CLOB API - WITH RETRY
...
app.post('/api/start', (req, res) => {
  ...
  logActivity('🚀 BOT STARTED - Fetching from Polymarket activity...', 'start');
...
server.listen(PORT, () => {
  console.log(`⚡ POLYMARKET COPY BOT - Activity Feed v1.0\n`);
});
